...
*/
	//private int calculateEnergy(List<Ogre> list) { //error messages due to wrong parameter
	...
	// problem is that argument must be List<Energy> instead of List<Ogre>...
	public int ogresEnergy() {
		return calculateEnergy(ogres);
	}
	// problem is that argument must be List<Energy> instead of List<Knight>...
	public int knightsEnergy() {
